...
KeyPaiSho.BoardPoint.prototype.removeTile = function (tileNum = 0) {
    var theTile = this.tile;

    for (i = 1; i < tileNum; tileNum--) {
        theTile = theTile.heldTile;
    }

    if (tileNum === 1) {
        var returnTile = theTile.heldTile;
        theTile.heldTile = null;
        return returnTile;
    } else {
        this.tile = null;
        return theTile;
